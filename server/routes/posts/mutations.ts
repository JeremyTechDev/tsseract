import { Thunk, GraphQLFieldConfigMap, GraphQLNonNull, GraphQLString, GraphQLObjectType, GraphQLList } from 'graphql';
...
const Mutations: Thunk<GraphQLFieldConfigMap<any, any>> = ({
    ...
    DeletePost: {
        ...
        resolve: async (_, args, ctx: Context) => {
            ...
            const { postId } = args;
            const post = (await Posts.findByIdAndDelete(postId)) as iPost;
