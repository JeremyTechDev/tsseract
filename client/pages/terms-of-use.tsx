...
const TermsOfUse = () => (
  <Container maxWidth="md">
    ...
    <Typography align="justify">
      ...
      the{' '}
      <Link href="https://www.termsofusegenerator.net">
    ...
    <Typography align="justify">
      ...
      should be sent to: Dominican Republic, Santiago de lo Caballeros. After
    ...
    <Typography align="justify">
      Address: Dominican Republic, Santiago de lo Caballeros
    </Typography>
    <Typography align="justify">Email: jeremy2918@gmail.com</Typography>
  </Container>
);
